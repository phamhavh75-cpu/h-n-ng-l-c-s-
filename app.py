...
<div class="main-header">
    ...
    <p>Tác giả: Phạm Thị Hà - Trường Tiểu học Vĩnh Hảo - ĐT: 0886 172 150</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Phạm Thị Hà - Trường Tiểu học Vĩnh Hảo - ĐT: 0886 172 150</div>", unsafe_allow_html=True)
